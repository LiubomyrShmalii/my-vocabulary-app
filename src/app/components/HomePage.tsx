  ...
  return (
    <div className="top">
      ...
      <button
        ...
        className="w-full px-4 py-2 mb-4 bg-blue-500 text-white rounded text-center"
      >
        Слова, які потрібно тестувати ({countWordsByStatus(1)})
      </button>
      <button
        onClick={() => onSelectStatus(2)}
        className="w-full px-4 py-2 mb-4 bg-green-500 text-white rounded text-center"
      >
        Слова, які знаю ({countWordsByStatus(2)})
      </button>
      <button
        onClick={() => onSelectStatus(3)}
        className="w-full px-4 py-2 bg-red-500 text-white rounded text-center"
      >
